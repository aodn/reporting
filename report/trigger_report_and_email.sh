...
email_trigger() {
    ./reporting_email_sender.sh "$cdate" ../report_logs/"$cdate" ../report_statuses/"$cdate" ../figures/eMII_data_report/AATAMS_EmbargoPlots/EmbargoPlot_"$zdate".jpeg hugo.oliveira@utas.edu.au "hugo.oliveira@utas.edu.au,jacqui.hope@utas.edu.au"
}
